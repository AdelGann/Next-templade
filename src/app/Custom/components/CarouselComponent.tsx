...
export function CarouselComponent() {
	const Imagenes = [
		{ id: "1", url: TShirts, name: "Camisas", price: "10$", urlContent: "/" },
		{ id: "2", url: Xbox, name: "xbox One", price: "190$", urlContent: "/" },
		{ id: "3", url: PC, name: "PC Intel® Core™ i7-1165G7", price: "500$", urlContent: "/" },
		{ id: "4", url: Celular, name: "Iphone 15", price: "450$", urlContent: "/" },
		{ id: "5", url: Cafetera, name: "Cafetera Oster", price: "120$", urlContent: "/" },
	];
			...
			<CarouselContent>
				{Imagenes.map((_, index) => (
					<CarouselItem key={index}>
						<div className="p-1">
							<a href={Imagenes[index]['urlContent']}>
								<Card>
									<h2 className="p-10 text-lg 2xl:text-6xl font-bold font-bebas">
										{Imagenes[index]["name"]}
									</h2>
